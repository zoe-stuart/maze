...
while not done:
    ...
    if stage == START:
        ...
        screen.blit(text1, [388 - (text_width1 / 2), 388 - 35])
        screen.blit(text2, [388 - (text_width2 / 2), 388 + 5])
        screen.blit(text3, [388 - (text_width3 / 2), 388 + 25])
    ...
    if stage == PLAYING:
        draw_image(wizard, player[0], player[1], scale, 2)
    ...
    if stage == END:
        ...
        screen.blit(text1, [388 - (text_width1 / 2), 388 - text_height1])
        screen.blit(text2, [388 - (text_width2 / 2), 388 + text_height1 / 2])
